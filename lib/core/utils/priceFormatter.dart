...
class PriceFormatter {
  static String format(int? price, {String currency = 'VND'}) {
    if (price == null) return 'Không có dữ liệu';
  ...
  static String formatRange(
    ...
    if (minPrice == null && maxPrice == null) return 'Không có dữ liệu';
    if (minPrice == null) return 'dưới ${format(maxPrice, currency: currency)}';
    if (maxPrice == null) return 'đến ${format(minPrice, currency: currency)}';
